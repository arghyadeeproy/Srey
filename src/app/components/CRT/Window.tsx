    ...
    <Draggable handle=".handle">
      <div className="w-[300px] h-[200px] border border-white bg-gray-200 relative font-mono shadow-lg overflow-hidden">
        ...
        {title === 'documents' ?(
          ...
          <div className="">
            <img src="https://de34i7k6qwgwc.cloudfront.net/uploads/img/folder-d42ea2.png" alt="Folder" className="w-8 h-8 mr-2" />
            <span className="">Day 1</span>
          </div>
        </div>
        ):(
          <div className="text-red-600 font-bold">Access Denied: Invalid Folder</div>
        )}
